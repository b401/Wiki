---
title: Slow Password guessing
date: M02-18-2023
author: i4
---
- Default lockout threshold: 5
- Lockout duration: 30
- Lockout observation window: 30
- This does not apply to RDP!
    - Newest windows releases now count logonfail for RDP!

## Using LDAP to guess
- See [Security/Windows/AD/enumeration](/wiki/Security/Windows/AD/enumeration.md)
```powershell
